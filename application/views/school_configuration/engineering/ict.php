<?php include_once('resources/includes/header.php');?> <!-- Php code includes the header of the page -->

<div  class="container fluid">
	<div class="row">
		<div class="col-xs-2"></div>
	
		<div class="software_all col-xs-8" style="border:1px solid #ccc;margin-top: 5%;box-shadow: 3px 3px 10px #999;">
		<h3 style="text-align: center;">Information Communication Technology (ICT)</h3><hr>
...
<?php include_once('resources/includes/footer.php');?> <!-- Php code includes the Footer of the page -->
